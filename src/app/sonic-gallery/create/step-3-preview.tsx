...
export function Step3Preview({ onPrev }: Step3PreviewProps) {
    ...
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 max-w-5xl mx-auto">
      ...
      <div className="lg:col-span-4 space-y-8">
        ...
        <div className="space-y-4">
          {[
            { label: '歌词生成', status: 'done', time: '0.8秒' },
            { label: '节奏对齐', status: 'done', time: '1.2秒' },
            { label: '最终混音', status: 'progress', progress: 84 },
          ].map((item, i) => (
        ...
        <div className="space-y-3 pt-4">
          ...
          <button className="w-full flex items-center justify-center gap-2 py-3.5 rounded-xl text-white/60 hover:text-white hover:bg-white/[0.03] border border-white/[0.06] transition-all font-['PingFang_SC','Noto_Sans_SC',sans-serif]">
